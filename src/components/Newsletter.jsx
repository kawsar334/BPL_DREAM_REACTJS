...
const Newsletter = () => {
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center w-[95%] md:w-[70%] p-3 border-[2px] bg-[rgba(255,255,255,0.4)] border-white rounded-[10px] absolute bottom-[-70px] z-5">
